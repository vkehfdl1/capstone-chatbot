"""
This code is from Visconde paper and its repo for evaluating Qasper dataset.
"""
"""
...
if __name__ == "__main__":
    ...
    with open(args.predictions, 'rb') as r:
        prediction_data = json.load(r)
    for data in prediction_data:
        predicted_answers_and_evidence[data["question_id"]] = {
            "answer": data["predicted_answer"],
            "evidence": data["predicted_evidence"]
        }
